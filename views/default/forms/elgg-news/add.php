...
if ($connected_entity_exists) {
    ...
    echo elgg_format_element('h3', [], elgg_echo('elggnews:add:connected_entity:title'));
}

echo elgg_format_element('p', [], elgg_echo('elggnews:add:requiredfields'));

echo elgg_view_field([
    '#type' => 'text',
    'name' => 'title',
    'value' => $title,
    '#label' => elgg_echo('elggnews:add:title'),
    '#help' => elgg_echo('elggnews:add:title:help'),
    'required' => true,
]);
...
echo elgg_view_field([
    ...
    'name' => 'excerpt',
    'value' => $excerpt,
    '#label' => elgg_echo('elggnews:add:excerpt'),
    '#help' => elgg_echo('elggnews:add:excerpt:help'),
    'required' => true,
]);
...
if (!$connected_entity_exists) { /* do not display description when is connected with other entity */
    echo elgg_view_field([
        ...
        'name' => 'description',
        'value' => $description,
        '#label' => elgg_echo('elggnews:add:description'),
        '#help' => elgg_echo('elggnews:add:description:help'),
    ]);
}
...
echo elgg_view_field([
    '#type' => 'file',
    'name' => 'photo',
    '#label' => elgg_echo('elggnews:add:photo'),
    '#help' => elgg_echo('elggnews:add:photo:help'),
]);
...
if (NewsOptions::canSetFeaturedNews()) {
    echo elgg_view_field([
        ...
        '#label' => elgg_echo('elggnews:add:featured'),
        '#help' => elgg_echo('elggnews:add:featured:help'),
    ]);
}
...
echo elgg_view_field([
    ...
    'name' => 'tags',
    'value' => $tags,
    '#label' => elgg_echo('elggnews:add:tags'),
    '#help' => elgg_echo('elggnews:add:tags:help'),
]);

if (!$connected_entity_exists) { /* do not display comments when is connected with other entity */
    echo elgg_view_field([
        '#type' => 'dropdown',
        'id' => 'elggnews_comments_on',
        'name' => 'comments_on',
...
$footer_fields = [
    ...
    [
        '#type' => 'submit',
        'value' => elgg_echo('elggnews:add:submit'),
    ],
];
